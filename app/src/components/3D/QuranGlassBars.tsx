...
const BARS: BarConfig[] = [
  {
    left: "2%",
    from: "color-mix(in srgb, var(--color-visual-teal) 85%, white)",
    to: "color-mix(in srgb, var(--color-visual-teal) 55%, white)",
  ...
  {
    left: "18%",
    from: "color-mix(in srgb, var(--color-visual-teal) 55%, transparent)",
    to: "color-mix(in srgb, var(--color-visual-teal) 35%, white)",
    glow: "color-mix(in srgb, var(--color-visual-teal) 48%, transparent)",
    drift: "driftC 12s",
  },
  {
    left: "26%",
    from: "color-mix(in srgb, var(--color-visual-teal) 40%, black)",
    to: "color-mix(in srgb, var(--color-visual-teal) 60%, black)",
    glow: "color-mix(in srgb, var(--color-visual-teal) 50%, transparent)",
    drift: "driftD 11s",
  },
];

export default function QuranGlassBars() {
  return (
