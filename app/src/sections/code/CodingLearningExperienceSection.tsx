...
const STEPS: Step[] = [
  {
    title: "لقاء مباشر",
    subtitle: "يبدأ الدرس مع المدرّس",
    description:
      "درس مباشر ضمن مجموعة صغيرة، يبدأ فيه الطالب من مستواه الفعلي، ويكتب الكود بنفسه بدل أن يكتفي بالمشاهدة.",
    tags: ["مباشر", "مجموعة صغيرة"],
  },
  {
    title: "كتابة وتصحيح",
    subtitle: "يكتب الطالب، ويصحّح المدرّس",
    description:
      "الطالب يكتب الكود بنفسه، ويراجع المدرّس المنطق والأخطاء لحظة بلحظة، ويشرح لماذا الحل الصحيح هو الأفضل.",
    tags: ["كتابة فعلية", "مراجعة مباشرة"],
  },
  {
    title: "تثبيت الأساسيات",
    subtitle: "ما تعلّمه لا يُترك للنسيان",
    description:
      "لا ننتقل دائمًا إلى مفهوم جديد. يُراجع الطالب ما سبق تعلّمه عبر تمارين قصيرة تثبّته قبل الانتقال إلى ما بعده.",
    tags: ["مفهوم جديد", "مراجعة", "تثبيت"],
  },
  {
    title: "تدريب بين الدروس",
    subtitle: "ويستمر التعلّم بعد انتهاء اللقاء",
    description:
      "يحصل الطالب على تمارين ومشاريع صغيرة يطبّق فيها ما تعلّمه، حتى يبقى متصلًا بالكود ولا يعتمد على وقت الحصة وحده.",
    tags: ["تمارين", "مشاريع صغيرة", "استعداد للدرس القادم"],
  },
  {
    title: "متابعة أسبوعية",
    subtitle: "نعرف أين وصل، وماذا يحتاج",
    description:
      "تُراجع رحلة الطالب باستمرار لمعرفة تقدّمه، وما يحتاج إلى مزيد من التدريب، وما إذا كان مستعدًا للانتقال إلى المسار التالي.",
    tags: ["تقدّم واضح", "مراجعة مستمرة"],
  },
];

const FLOW_WORDS = ["يتعلّم", "يكتب", "يُصحّح", "يبني", "يتقدّم"];

/** Nokta-ayraçlı metin — chip/badge yerine, TermsRow ailesiyle aynı dil. */
...
/** Son karta özel — markanın nokta desenine göz kırpan minik köşe motifi. */
...
export default function CodingLearningExperienceSection() {
  return (
      ...
      <SectionContainer>
        <div className="max-w-[620px]">
          ...
          <p className="font-thmanyah-text text-body text-neutral-600 leading-7 mt-5">
            لا نترك الطالب وحده أمام الشاشة.
            <br />
            من أول سطر كود إلى المتابعة الأسبوعية، يمرّ الطالب بخطوات واضحة
