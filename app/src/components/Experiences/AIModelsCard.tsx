  ...
  return (
    <div className="relative bg-neutral-0 border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
      <div
        ...
        style={{
          // ضع الصورة التي أرسلتها هنا: /public/images/ai-experience-bg.png
      ...
      >
        ...
        {/* عنوان ووصف البطاقة — داخل المساحة البصرية مباشرة، أعلى يمين حيث الصورة أفتح */}
        <div dir="rtl" className="absolute top-10 right-10 z-30 max-w-sm">
     
          <h3 className="font-thmanyah-display font-bold text-[26px] leading-[1.3] text-neutral-900">
           دعم الذكاء الاصطناعي
          </h3>
          <p className="font-thmanyah-text text-[14px] leading-7 text-neutral-700 mt-3">
           بينما ينتهي الدرس، تبدأ مرحلةٌ جديدة من التعلّم. طوّر فريق راوي من المعلمين والمهندسين نماذج ذكاء اصطناعي ترافق الطالب في كل خطوة؛ تشرح المفاهيم، وتجيب عن الأسئلة، وتقترح تمارين تناسب مستواه، وتتابع تقدّمه، ليبقى باب التعلّم مفتوحًا في أي وقت.
          </p>
        </div>

        {/* النافذة الزجاجية — تحتوي على المشهد المتحرك: فيديو الدرس ثم تحوّل سينمائي إلى مكتب + حاسوب + روبوت */}
        <div
          dir="rtl"
          className="absolute left-[6%] top-[36%] -translate-y-1/2 w-[580px] rounded-xl overflow-hidden bg-neutral-0/45 backdrop-blur-xl border border-neutral-0/60 shadow-[0_35px_70px_-25px_rgba(20,16,40,0.3)]"
        >
          <div className="flex items-center gap-1.5 px-5 py-3 bg-neutral-0/40 backdrop-blur-md border-b border-neutral-0/50">
          ...
          <div className="p-5 space-y-3">
            ...
            >
              <defs>
                {/* تدرج خط الطالب — بنفسجي فاتح إلى بنفسجي عميق، بلا تعبئة */}
                ...
                {/* تدرج سماعة الرأس — لمسة premium بلون العلامة الثانوي (برتقالي) */}
                ...
                {/* لمعة زجاجية ناعمة أعلى يسار الأشكال — تمنح إحساس Apple/Stripe الملموس */}
              ...
              {/* ===== عناصر مشتركة تبقى ثابتة طوال الدورة ===== */}

              {/* توهج محيط خلف الطالب */}
              <circle cx="393" cy="140" r="98" fill="url(#premGlow)" filter="url(#premSoftBlur)" />

              {/* المكتب — خط واحد كبير يمتد على كامل العرض، خلف الطالب تمامًا */}
              ...
              {/* الطالب — رسم خطي محسّن بلمسة premium */}
              ...
              {/* عُقد ذكاء اصطناعي عائمة — نبض هادئ مستمر بغض النظر عن المشهد */}
              <g opacity="0.85">
              ...
              {/* ===== المشهد الأول: نافذة الفيديو + المعلّم ===== */}
              ...
              {/* ===== المشهد الثاني: المكتب + الحاسوب المحمول + الروبوت ===== */}
              <g className="scene scene-robot">
                {/* مكتب بمنظور صحيح — الحافة السميكة في الجهة البعيدة القريبة من الطالب */}
        ...
        <div
          dir="rtl"
          className="absolute right-[6%] top-[66%] -translate-y-1/2 w-[380px] rounded-xl overflow-hidden bg-neutral-0/45 backdrop-blur-xl border border-neutral-0/60 shadow-[0_35px_70px_-25px_rgba(20,16,40,0.3)]"
        >
          <div className="flex items-center gap-1.5 px-5 py-3 bg-neutral-0/40 backdrop-blur-md border-b border-neutral-0/50">
          ...
          <div className="p-5 space-y-3">
            <div className="flex justify-start">
              <div className="max-w-[80%] bg-neutral-0/70 backdrop-blur-md rounded-2xl rounded-tr-sm px-4 py-2.5 shadow-sm">
                <p className="text-[12.5px] text-neutral-700 leading-6">
            ...
            <div className="flex justify-end">
              <div className="max-w-[70%] bg-primary rounded-2xl rounded-tl-sm px-4 py-2.5 shadow-sm">
                <p className="text-[12.5px] text-neutral-0 leading-6">
        ...
        {/* بطاقة إحصائية عائمة — أسفل يمين */}
        <div
          dir="rtl"
          className="absolute bottom-6 right-[6%] bg-neutral-0/80 backdrop-blur-md border border-neutral-0/70 rounded-xl shadow-[0_20px_45px_-18px_rgba(80,60,180,0.3)] px-5 py-3.5 max-w-[260px]"
        >
      ...
      <style jsx>{`
        /* ============================================================
           دورة المشهد الكاملة: فيديو → تحوّل سينمائي → مكتب/روبوت → رجوع
           المدة الكلية 11 ثانية، بمنحنى تسارع/تباطؤ يشبه انتقالات Apple
           ============================================================ */
        .scene {
        ...
        /* رسم منحنى التقدّم تدريجيًا في كل مرة يظهر فيها مشهد الفيديو */
        .progress-curve {
          stroke-dasharray: 1;
          stroke-dashoffset: 1;
        ...
        /* نبض هادئ حول زر التشغيل — يلفت الانتباه دون إزعاج */
        .play-ring {
        ...
        /* ذراع المعلّم تشير نحو السبورة بحركة خفيفة جدًا */
        .teacher-arm {
          transform-box: fill-box;
        ...
        /* الروبوت يطفو بلطف طوال ظهوره — إحساس عائم Apple-like */
        .robot-float {
        ...
        /* ذراع الروبوت تلوّح بترحيب عند ظهوره */
        .robot-arm-wave,
        .robot-hand-wave {
          transform-box: fill-box;
        ...
        /* عُقد الذكاء الاصطناعي العائمة — تلألؤ غير متزامن */
        .ai-node {
