...
const steps: Step[] = [
  {
    title: "اختر مسارك",
    description:
      "استكشف مساراتنا المتنوعة واختر المسار الأنسب لأهدافك واهتماماتك.",
  ...
  },
  {
    title: "أتقن وانطلق",
    description:
      "طوّر مهاراتك، أكمل متطلبات المسار، واحصل على شهادة تُفتح لك أبواب الفرص.",
      ...
      <div className="max-w-7xl mx-auto px-10">
        <div className="max-w-xl mb-10">
          ...
          <p className="font-thmanyah-text text-[14px] leading-7 text-[#3F3F52] mt-3 text-justify">
            رحلتك من اختيار المسار إلى إتقان المهارة، صمّمنا كل خطوة لتكون واضحة
