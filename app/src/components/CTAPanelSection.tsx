        ...
        <div className="relative bg-neutral-900 border border-neutral-900 rounded-lg overflow-hidden shadow-sm">
          ...
          >
            ...
            <div dir="rtl" className="relative z-10 flex items-center justify-center h-full p-6 sm:p-16">
              <div
                className={`w-full sm:w-[560px] rounded-sm backdrop-blur-2xl border shadow-[0_30px_60px_-20px_rgba(0,0,0,0.55)] p-8 sm:p-12 flex flex-col items-center text-center ${
                  isLightText
                    ? "bg-neutral-0/[0.08] border-neutral-0/[0.14]"
                    : "bg-neutral-900/[0.08] border-neutral-900/[0.14]"
                }`}
              >
                <h3
                  className={`font-thmanyah-display font-bold text-h3-sm sm:text-h2-sm leading-[1.35] ${
                    isLightText ? "text-neutral-0" : "text-neutral-900"
                  }`}
                >
                  {title}
                </h3>
                ...
                <p
                  className={`font-thmanyah-text text-caption sm:text-body leading-6 sm:leading-7 mt-5 mb-10 max-w-[400px] ${
                    isLightText ? "text-neutral-300" : "text-neutral-600"
                  }`}
                >
                  {description}
                </p>
