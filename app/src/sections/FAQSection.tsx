...
const faqs = [
  {
    ...
    a: "لا، تبدأ جميع المسارات من المستوى المناسب، سواء كنت مبتدئًا أو لديك أساسيات مسبقة.",
  },
  {
    q: "هل توجد شهادة بعد الإكمال؟",
    a: "نعم، تحصل على شهادة بعد إتمام المسار بنجاح.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم، توجد مسارات مخصصة للأطفال بأسلوب تعليمي مبسط ومناسب لأعمارهم.",
  },
  {
    q: "كيف أبدأ؟",
    a: "اختر المسار المناسب لك، ثم ابدأ رحلتك التعليمية بخطوات واضحة ومتدرجة.",
  },
];
