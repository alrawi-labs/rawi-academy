 ...
 *
 * هذا القسم يُغلق الدائرة مع الـHero عمدًا: نفس التركيبة (عنوان ضخم +
 * خط فاصل رأسي + فقرة) ونفس توهج البينك العلوي، لكن بلا Marquee وبلا
 * زجاج ثلاثي الأبعاد — الحركة استُنفدت في بداية الصفحة، وهنا نحتاج هدوءًا
 * لا تكرارًا. الفرق الوحيد: العنوان هنا مركزي لا يميني، لأنه خلاصة لا
 * افتتاحية، والزر يظهر كخط ختامي هادئ تحت الفقرة بدل أن يكون CTA صارخًا.
 */

export function LanguageClosingCta() {
  ...
  return (
    ...
    >
      {/* نفس توهج الـHero، لكن من الأسفل هذه المرة — إشارة بصرية إلى أننا وصلنا لنهاية الرحلة */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(120% 90% at 50% 100%, color-mix(in srgb, var(--color-visual-pink) 14%, transparent) 0%, transparent 55%)",
        }}
      />
      ...
      <SectionContainer>
        <div className="relative flex flex-col items-center pt-28 text-center lg:pt-40">
          ...
          >
            العالم أكبر <span className="text-visual-pink">من لغة واحدة</span>
          </h2>
          ...
          <div ref={bodyRef} className="mt-10 lg:mt-14">
            <p className="font-thmanyah-text text-body sm:text-lead leading-relaxed text-neutral-600 max-w-md mx-auto">
              اختر لغة جديدة، ووسّع ما يمكنك أن تتعلمه، وتعمله، وتفهمه، وتصل
              إليه.
            </p>
          </div>
        </div>
...
export default LanguageClosingCta;
